class BlueprintSave
  ...
  def save
    ::Repository::Repository.new.save_blueprint_version(blueprint_version_path, blueprint_version_yaml, blueprint_version_readme)
  end

  def blueprint_version_path
    @blueprint_version_path ||=
      [
        blueprint_version.software_version.software.short_title.underscore || 'no_software_short_title',
        blueprint_version.software_version.version.underscore || 'no_software_version',
        blueprint_version.name.underscore || 'no_blueprint_name'
      ].join '/'
  end
